                        ...
                        <table class="table-fixed table table-report -mt-2">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center whitespace-nowrap">Driver</th>
                                    <th class="text-center whitespace-nowrap">License plate</th>
                                    <th class="text-center whitespace-nowrap">Confirm Date</th>
                                    <th class="text-center whitespace-nowrap">Next Step</th>
                                    <th class="text-center whitespace-nowrap">Status</th>
                                    <th class="text-center whitespace-nowrap">Scan</th>
                                    <th class="text-center whitespace-nowrap">Fill in</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="intro-x">
                                    ...
                                    <td class="text-center">Suvit Loprasert</td>
                                    <td class="text-center">1กข 8955-0123</td>
                                    <td class="w-40">
                                        <div class="flex items-center justify-center text-success"> <i data-lucide="check-square" class="w-4 h-4 mr-2"></i> 25 Aug 2024 </div>
                                    </td>
                                    <td class="w-40">
                                        <div class="flex items-center justify-center"> Truck In </div>
                                    </td>
                                    <td class="w-56">
                                    ...
                                    <td class="text-center">
                                        <div class="flex flex-row">
                                            <button class="btn btn-border-none mr-2" onclick="location.href='ScanBarcode.php';">
                                                <div class="w-8 h-8 bg-primary/10 dark:bg-primary/20 text-primary/80 flex items-center justify-center rounded-full"> <i class="w-4 h-4" data-lucide="scan"></i> </div>
                                            </button>                                            
                                        </div>
                                    </td>
                                    <td class="text-center">
