                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-3/4">
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button class="btn btn-outline-secondary py-3 px-4 w-full mt-3 xl:mt-0 align-top user_icon hmc" onclick="location.href='home.php';"><i data-lucide="user"></i><span>Login</span></button>
                        </div>
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button class="btn btn-secondary py-3 px-4 w-full mt-3 xl:mt-0 align-top bg-white" onclick="location.href='home.php';"><img alt="Selling Application" class="-intro-x-mt-16 p-1" src="../../dist/images/365-logo.png"><span>Login via Sign-on 365</span></button>
                        </div>
                    </div>
                </div>
                <!-- END: Login Form -->
