            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-primary shadow-md mr-2 dropdown-toggle btn px-6 pl-6 mx-4" onclick="location.href='CreateMasterDIWData.php';">
                                Master New
                        ...
                        <table class="table table-report -mt-2">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center whitespace-nowrap">Create by</th>
                                    <th class="text-center whitespace-nowrap">Modify Date</th>
                            ...
                            <tbody>
                                <tr class="intro-x">
                                    ...
                                    <td class="text-left">ประเภทกรมโรงงาน</td>
                                    <td class="text-center">
                                        <a href="" class="font-medium whitespace-nowrap">บรรจุภัฑณ์</a>                                        
                                    </td>
