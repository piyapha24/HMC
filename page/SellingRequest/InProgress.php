                ...
                <div class="intro-y box px-5 pt-5 mt-5">
                    ...
                    <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
                        ...
                        <div class="grow w-full px-5 items-center justify-start lg:justify-start">
                            <div class="mt-3">
                                ...
                                <input id="input-state-1" type="text" class="form-control" placeholder="Tiyakorn" disabled>
                            </div>
                        </div>
                        <div class="grow w-full px-5 items-center justify-start lg:justify-start">
                            <div class="mt-3">
                    ...
                    <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
                        ...
                        <div class="flex flex-auto w-64 md:w-full px-5 items-center justify-start lg:justify-start">
                            <div class="mt-3"> <label for="input-state-1" class="form-label">Unit Price: THB</label> <input id="input-state-1" type="text" class="form-control state--b-blue" placeholder="Input Auto" disabled>
                            </div>
                        </div>
                        <div class="flex flex-auto w-64 md:w-full px-5 items-center justify-start lg:justify-start">
                            <div class="mt-3"> <label for="input-state-1" class="form-label">Unit</label> <input id="input-state-1" type="text" class="form-control state--b-blue" placeholder="Input Auto" disabled>
                            </div>
                        </div>
                    </div>
                    <!-- BEGIN: Info ROW-->
                ...
                <div class="intro-y box px-5 pt-5 mt-5">
                    <table class="table-fixed table table-report -mt-2 table-customer">
                        ...
                        <tbody>
                            ...
                            <tr class="intro-x">
                                <td class="text-left">Reqester</td>
                                <td class="text-left">Tiyakorn</td>
                                <td class="text-left">Approve</td>
                                <td class="text-left">Note</td>
                                <td class="text-center">In</td>
                            ...
                            <tr class="intro-x">
                                <td class="text-left">ผู้จัดการ ของ Reqester</td>
                                <td class="text-left">Tiyakorn</td>
                                <td class="text-left">Approve</td>
                                <td class="text-left">Note</td>
                                <td class="text-center">In</td>
                            ...
                            <tr class="intro-x">
                                <td class="text-left">ผู้จัดการฝ่ายจัดซื้อ</td>
                                <td class="text-left">Tiyakorn</td>
                                <td class="text-left">Approve</td>
                                <td class="text-left">Note</td>
                                <td class="text-center">In</td>
