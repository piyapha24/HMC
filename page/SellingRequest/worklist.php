                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content">
                                    <li>
                                        <a href="../../page/SellingRequest/CreatSCR.php" class="dropdown-item"> <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Create New SCR </a>
                                    </li>
                                    <li>
                                        <a href="../../page/SellingRequest/CreatADR.php" class="dropdown-item"> <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Create New ADR </a>
                                    </li>
                                    <li>
                                        <a href="../../page/SellingRequest/CreatGRD.php" class="dropdown-item"> <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Create New GRD </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
