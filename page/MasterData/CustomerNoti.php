            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-primary shadow-md mr-2 dropdown-toggle btn px-6 pl-6 mx-4" onclick="location.href='../../page/MasterData/CreateNoti.php';">
                                Create New
                    ...
                    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                        <table class="table-fixed table table-report -mt-2 table-customer">
                            <thead>
                                <tr>                                    
                                    <th class="whitespace-nowrap">User Create</th>
                            ...
                            <tbody>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="text-center">A lump sum is a single payment of money, as opposed to a series of payments made over time. The United States Department of Housing and Urban Development distinguishes between "price analysis" and "co</td>
                                    ...
                                    <!-- <div class="table-more">
                                        <table class="table-more t-status-1 table table-report -mt-2" >
                                ...
                                <tr class="intro-x">                                    
                                    ...
                                    <div class="table-more">
                                        <table class="table-more t-status-2 table table-report -mt-2" >
                                            <thead class="t-more-thead bg-blue-500 m-2 p-2 text-white" >
                                                <tr>
                                                <th class="whitespace-nowrap">Address</th>
                                                <th class="whitespace-nowrap">E-mail สำหรับรับใบงาน</th>
